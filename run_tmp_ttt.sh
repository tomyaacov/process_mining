...
#SBATCH --job-name tmp_ttt ### name of the job. replace my_job with your desired job name
#SBATCH --output tmp_ttt.out ### output log for running job - %J is the job number variable
...
/home/tomya/.conda/envs/process_mining/bin/python tmp_ttt.py