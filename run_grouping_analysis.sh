...
#SBATCH --job-name run_rpni_tictactoe ### name of the job. replace my_job with your desired job name
...
/home/tomya/.conda/envs/process_mining/bin/python grouping_analysis.py