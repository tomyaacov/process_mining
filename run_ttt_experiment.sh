...
#SBATCH --job-name ttt_experiment ### name of the job. replace my_job with your desired job name
#SBATCH --output ttt_experiment.out ### output log for running job - %J is the job number variable
...
/home/tomya/.conda/envs/process_mining/bin/python ttt_experiment.py