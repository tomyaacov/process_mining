...
#SBATCH --job-name ttt_traces_to_log100k ### name of the job. replace my_job with your desired job name
#SBATCH --output ttt_traces_to_log100k.out ### output log for running job - %J is the job number variable
...
/home/tomya/.conda/envs/process_mining/bin/python ttt_traces_to_log.py