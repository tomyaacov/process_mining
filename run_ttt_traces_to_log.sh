...
#SBATCH --job-name ttt_traces_to_log50k ### name of the job. replace my_job with your desired job name
#SBATCH --output ttt_traces_to_log50k.out ### output log for running job - %J is the job number variable
